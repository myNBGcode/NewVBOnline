...
Begin VB.UserControl CompressZIt 
   ...
   ScaleHeight     =   690
   ScaleWidth      =   630
   ToolboxBitmap   =   "CompressZ.ctx":0000
   Begin VB.Image Image1 
      Height          =   480
      Left            =   0
      Picture         =   "CompressZ.ctx":00FA
      Top             =   0
      Width           =   480
   End
End
...
Result = compress2(TempBuffer(0), BufferSize, TheData(0), UBound(TheData) + 1, 9)
...
ret = compress2(ByVal TBuff, CmpSize, ByVal TheString, Len(TheString), 9)
