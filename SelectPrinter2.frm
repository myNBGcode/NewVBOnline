...
Public excludepassbook As Boolean

Public Sub UpdateForm()

Dim x As Printer, i As Integer
i = 0
If Not excludepassbook Then PrinterList.AddItem "Passbook": PrinterList.ListIndex = 0
...
For Each x In Printers
    ...
    i = i + 1
Next
If excludepassbook And PrinterList.ListCount > 0 Then PrinterList.ListIndex = 0
End Sub
...
Private Sub PrinterList_DblClick()
    SelectedPrinter = PrinterList.Text: Hide
End Sub
